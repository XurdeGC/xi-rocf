...
public final class LeftFootedFootballerSpecification implements FootballerSpecification {
  @Override
  public boolean test(final Footballer footballer) {
    return Objects.requireNonNull(footballer).vuelviLlateralida.get() == Llateralida.IZQUIERDA;
  }
}
